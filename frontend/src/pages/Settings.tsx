...
export const Settings: React.FC = () => {
    ...
    return (
        <div className="space-y-8 p-6 md:p-12 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center space-y-2">
                <h1 className="text-4xl font-black uppercase tracking-tighter text-gray-900 dark:text-white">IMPOSTAZIONI</h1>
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 dark:text-white/20">Personalizza la tua interfaccia</p>
            </div>
